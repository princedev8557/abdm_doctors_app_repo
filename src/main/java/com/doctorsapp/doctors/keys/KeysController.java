package com.doctorsapp.doctors.keys;
...
public class KeysController {
    ...
    private KeyPair generateKeyPair() throws NoSuchProviderException, NoSuchAlgorithmException, InvalidAlgorithmParameterException {
        ...
        KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance(AppConstants.ALGORITHM, AppConstants.PROVIDER);
        X9ECParameters ecParameters = CustomNamedCurves.getByName(AppConstants.CURVE);
