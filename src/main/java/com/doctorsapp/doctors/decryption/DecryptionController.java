package com.doctorsapp.doctors.decryption;
...
public class DecryptionController {
    ...
    private String doECDH(byte[] dataPrv, byte[] dataPub) throws Exception {
        KeyAgreement ka = KeyAgreement.getInstance(AppConstants.ALGORITHM, AppConstants.PROVIDER);
    ...
    private PrivateKey loadPrivateKey(byte[] data) throws Exception {
        X9ECParameters ecP = CustomNamedCurves.getByName(AppConstants.CURVE);
        ...
        KeyFactory kf = KeyFactory.getInstance(AppConstants.ALGORITHM, AppConstants.PROVIDER);
        return kf.generatePrivate(privateKeySpec);
    }

    private PublicKey loadPublicKeyForProjectEKAHIU(byte[] data) throws Exception {
        KeyFactory ecKeyFac = KeyFactory.getInstance(AppConstants.ALGORITHM, AppConstants.PROVIDER);
